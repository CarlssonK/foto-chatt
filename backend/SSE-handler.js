...
module.exports = app => {
  ...
  app.get("/api/sse", (req, res) => {
      ...
      req.on('close', () => {
        ...
        const user = connections.find(e => e.user.email === req.user.email && e.user.username === req.user.username);
  ...
  app.get("/api/leaveroom", (req, res) => {
    ...
    connections = connections.map((e) => {
      if (e.user.email === req.user.email && e.user.username === req.user.username) {
          roomId = e.roomId
          e.roomId = null;
      }
      return e;
